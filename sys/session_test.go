...
func TestSetSessionCookie(t *testing.T) {
	...
	t.Run("Create New Session", func(t *testing.T) {
		...
		e := sys.SetSessionCookie()(func(c echo.Context) error {
			return nil
		})
    ...
    t.Run("Rotate Existing Session", func(t *testing.T) {
        ...
        sys.SetSessionCookie()(func(c echo.Context) error { return nil })(ctx1)
        ...
        if err := sys.SetSessionCookie()(func(c echo.Context) error { return nil })(ctx2); err != nil {
    ...
    t.Run("Recreate if Invalid Session", func(t *testing.T) {
         ...
         if err := sys.SetSessionCookie()(func(c echo.Context) error { return nil })(ctx); err != nil {
             t.Fatalf("Middleware returned error: %v", err)
         }
...
func TestVerifySessionCookie(t *testing.T) {
    ...
    t.Run("Valid Session", func(t *testing.T) {
        ...
        handler := sys.VerifySessionCookie()(func(c echo.Context) error {
