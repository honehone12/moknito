...
const (
	// Label holds the string label denoting the ownedapp type in the database.
	Label = "owned_app"
	...
	// Table holds the table name of the ownedapp in the database.
	Table = "owned_apps"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "owned_apps"
...
// Columns holds all SQL columns for ownedapp fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the OwnedApp queries.
